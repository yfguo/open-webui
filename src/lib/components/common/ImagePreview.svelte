...
{#if show}
	...
	<div
		...
		class="modal fixed top-0 right-0 left-0 bottom-0 bg-black text-white w-full min-h-main-content-area h-main-content-area flex justify-center z-9999 overflow-hidden overscroll-contain"
	>
