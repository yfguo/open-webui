...
<div
	class="h-main-content-area max-h-main-content-area transition-width duration-200 ease-in-out {$showSidebar
	...
	<PaneGroup direction="horizontal" class="w-full h-full">
		...
		{#if !largeScreen}
			{#if threadId !== null}
				...
				>
					<div class=" {threadId !== null ? ' h-main-content-area  w-full' : 'px-6 py-4'} h-full">
						<Thread
							{threadId}
							{channel}
							onClose={() => {
